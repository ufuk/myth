...
import com.ufukuzun.myth.controller.jsonbinding.request.ParentModelAjaxRequest;
...
public class ComplexObjectExampleController {
    ...
    @AjaxResponseBody
    public AjaxResponse bindModel(@AjaxRequestBody ParentModelAjaxRequest ajaxRequest, ModelAndView modelAndView) {
